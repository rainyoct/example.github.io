...
### 最后还是用安装简单的doxygen替代了CodeViz，或许这就是人生吧

<br>
[Linux下安装Doxygen+Graphviz](https://www.cnblogs.com/274914765qq/p/4443328.html)（配置较老，需要参考Windows的选项手动配置）

[Windows下的安装及配置](https://blog.csdn.net/benkaoya/article/details/79763668)